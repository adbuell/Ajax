window.onload = function() {
  ...
  var bands = ["Nirvana", "Stone Temple Pilots", "Pearl Jam", "Ramones", "The Clash"];
  ...
  function displayGif() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?api_key=" + APIKey + "&q=" + bands + "&limit=10&lang=en";
